"""
Django settings for calc_40510 project.
...
WSGI_APPLICATION = 'calc_40510.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "calc_40510 API",
    "DESCRIPTION": "API documentation for calc_40510 App",
    "VERSION": "v1",
}
